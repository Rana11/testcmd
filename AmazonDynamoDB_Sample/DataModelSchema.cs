...
namespace AmazonDynamoDB_Sample
{
    ...
    public class Movie
    {
        ...
        {
            return string.Format(@"{0} - {1} Actors: {2}", Title, ReleaseDate, string.Join(", ", ActorNames.ToArray()));
        }
    }
